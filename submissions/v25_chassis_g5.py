...
# ---------------------------------------------------------------------------
# IWA_setu v25 (2026-09-22): reflex constants re-tuned by search (experiments/evolve_chassis.py) against the
# reactive public pool (mirror, tetsutani demand-preserving, Ahmed V47/V48/V56, alperen first-in-line/market-rhythm,
# tetsutani shopwork). Everything above this block is the byte-exact public farm2945 v9/4 file (Apache-2.0, notices kept).
# The layers read these module constants at call time, so overriding them here changes play without editing the layers.
# ---------------------------------------------------------------------------
V9_HERD_MIN_MILK = 167
V9_RACE_DEFAULT = 35
V9_RACE_GAP = 2
V9_RACE_WINDOW = 38
_CA_TO = 27
...
_OR2_SLOT_H = 9
_HD2_FROM = 234
_HD2_MIN_GAIN = 575.586
_HD2_CARE = 0.673
_CS_MIN_GAIN = 1371.966
agent = globals().pop('agent')   # keep Kaggle's last-callable rule pointing at the full stack
