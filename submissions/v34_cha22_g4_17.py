...
# ---------------------------------------------------------------------------
# IWA_setu v34 cha22 run-4 gen-17 constants re-tuned by search (experiments/evolve_chassis.py, CHASSIS=cha22) against the reactive
...
# ---------------------------------------------------------------------------
V9_COURIER_FROM_HOUR = 14
V9_CARROT_RATIO = 1.74
V9_CARROT_FIRST_DAY = 4
V9_CARROT_WHEAT_RESERVE = 29
V9_CARROT_BOOM_RESERVE = 12
V9_HERD_MIN_WOOL = 210
V9_HERD_MIN_MILK = 87
V9_HERD_MAX_EGG_SHOPS = 0
V9_FERT_FIRST_DAY = 11
V9_RACE_DEFAULT = 58
_CA_TO = 38
_CA_FEED_DAYS = 0
_OR2_SN_H = 20
...
_HD2_LOOKBACK = 4
_HD2_FUTURE = 0.014
_CS_MIN_GAIN = 419.303
_RACE_HORIZON_CLONE = 6
_ADV_LOOK = 4
