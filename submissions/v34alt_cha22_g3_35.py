...
# ---------------------------------------------------------------------------
# IWA_setu v34 cha22 run-3 gen-35 constants re-tuned by search (experiments/evolve_chassis.py, CHASSIS=cha22) against the reactive
...
V9_CARROT_BOOM_RESERVE = 9
V9_HERD_MIN_WOOL = 111
V9_HERD_MIN_MILK = 40
V9_HERD_MAX_EGG_SHOPS = 0
V9_HERD_MIN_MILK_SHOPS = 4
V9_FERT_FIRST_DAY = 13
V9_RACE_MARGIN = 24
V9_RACEPX_MARGIN = 1
_CA_FROM = 15
_CA_MARGIN = -33.598
